...
<body>
            ...
            <div class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="weekend-meals.php">Weekend meals</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm">
                <figure class="photo">
                    <img src="../../../images/cottage-pie.png" alt="sample image" />
                    <figcaption>
                        <h2>Cottage pie</h2>
                    </figcaption>
                    <a href="cottage-pie.php"></a>
                </figure>
            </div>
            <div class="col-sm">
                <figure class="photo">
