...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img class="img-fluid rounded" style="float:center" src="../../../images/pasta-with-ragu.png"
                    alt="pasta-with-ragù">
            </div>
            <div class="col-sm-6">
                <h3>Ingredients:</h3>
                <ul>
                    <li>350g tagliatelle</li>
                    <li>500g mince</li>
                    <li>2 onions</li>
                    <li>3-5 carrots</li>
                ...
                <p>
                    Serves 4 + sauce for 6 more portions.
                </p>
            </div>
        </div>
    </div>
