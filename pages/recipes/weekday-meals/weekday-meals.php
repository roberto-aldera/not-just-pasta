...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm">
                <figure class="photo">
                    <img src="../../../images/couscous-chickpeas.png" alt="sample image" />
                    <figcaption>
                        <h2>Couscous and chickpeas</h2>
                    </figcaption>
                    <a href="couscous-chickpeas.php"></a>
                </figure>
            </div>
            <div class="col-sm">
                <figure class="photo">
                    <img src="../../../images/chicken-a-la-king.png" alt="sample image" />
                    <figcaption>
