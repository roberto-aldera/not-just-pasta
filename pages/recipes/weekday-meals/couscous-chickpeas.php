...
<head>
    <title>Couscous chickpeas</title>
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img class="img-fluid rounded" style="float:center" src="../../../images/couscous-chickpeas.png"
                    alt="couscous">
            </div>
            <div class="col-sm-6">
                <h3>Ingredients</h3>
                <ul>
                    ...
                    <li>Broccoli</li>
                    <li>Bacon/sausage</li>
                    <li>Chopped tomatoes (baby ones are sweeter)</li>
                    <li>Chicken</li>
                    <li>Balsamic vinegar</li>
                    <li>Onion</li>
                    <li>1 tin chickpeas (or 125g dried)</li>
                    <li>Mixed herbs</li>
                </ul>
                <ol>
                <h3>Instructions</h3>
